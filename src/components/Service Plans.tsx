        ...
        <Slider {...settings}>
          {Plans.map((plan, index) => (
            <div key={index} className="p-5 flex flex-col items-center h-full">
              <div className="bg-[#1a1a1a] border border-gray-800 rounded-2xl shadow-lg p-6 text-center w-80 mx-auto hover:scale-105 transition-transform duration-300 min-h-[500px] flex flex-col">
                <p
                ...
                <ul className="text-left mt-5 space-y-2 text-gray-300 flex-grow">
